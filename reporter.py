...
error_classes = {
    "C9": {"category": category_complexity},
    "E": {"category": category_style},
    "E7": {"category": category_clarity},
    "E9": {"category": category_bug},
    "F4": {"category": category_bug},
    "F6": {"category": category_bug},
    "F7": {"category": category_bug},
    "F8": {"category": category_bug},
    "W": {"category": category_style},
    "W6": {"category": category_compatibility},
}
